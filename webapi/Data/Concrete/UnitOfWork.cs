...
namespace webapi.Data.Concrete
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(Context dataContext, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public UnitOfWork(Context dataContext, int UserId)
        {
            _dataContext = dataContext;
            _repositories = new Dictionary<string, dynamic>();
            _UserId = UserId;
        ...
        MainDbContext IUnitOfWork.GetContext()
        {
